        ...
        <div class="row">
            <div class=" d-flex col-md-12 bg-secondary p-1 align-items-center">
                <div class="px-2">
                    ...
                    <p class="text-light text-center">riya sharma</p>
                </div>
                <div class="button text-center">
                    <button><a href="" class="nav-link text-light bg-info my-1">Insert Categories</a></button>
                    <button><a href="index.php?insert_category" class="nav-link text-light bg-info my-1">show Categories</a></button>
                    ...
                    <button><a href="" class="nav-link text-light bg-info my-1">hii hello</a></button>
                </div>
            </div>
        </div>
